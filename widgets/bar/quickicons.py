from gi.repository import Gtk, AstalNetwork, GObject
...
class NetworkIndicator(Gtk.Image):
    def __init__(self):
        ...
        self.net.connect('notify::icon-name', self.on_icon_change)
        self.net.connect('notify::ssid', self.on_ssid_change)

        self.on_icon_change(None, None)
        self.on_ssid_change(None, None)
    
    def on_icon_change(self, _, __):
        self.set_from_icon_name(self.net.icon_name)
    
    def on_ssid_change(self, _, __):
        self.set_tooltip_text(self.net.ssid)